...
public class UserLogin extends MultiDexApplication {
    ...
    public static final String AUTHTOKEN_TYPE = "com.example.vishwashrisairm.materialdesign";
    public static final String ACCOUNT_TYPE = "com.example.vishwashrisairm.materialdesign";
