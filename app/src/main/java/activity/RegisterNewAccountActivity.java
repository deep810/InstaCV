...
public class RegisterNewAccountActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mEditEmailAddress = (EditText) findViewById(R.id.email);
		mEditPassword = (EditText) findViewById(R.id.password);
		mEditPasswordConfirm = (EditText) findViewById(R.id.cpassword);
		kinveyClient = ((activity.UserLogin) getApplication()).getKinveyService();
	}
